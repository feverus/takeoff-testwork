...
//авторизация
function clickLogin(login: string, password: string, navigate: Function, doLogin: Function, onLoginFail: Function, doSnackbarPush: Function) {
    ...
    .then((result) => {	
        if (result.length>0) {
            if ((typeof result[0].name==="string") && (typeof result[0].token==="string")) {
                navigate('/takeoff/contacts');	
